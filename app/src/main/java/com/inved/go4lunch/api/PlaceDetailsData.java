...
public class PlaceDetailsData{
    ...
    public void fetchPlaceRequest(String currentPlaceId) {
        ...
        placesClient.fetchPlace(request).addOnSuccessListener((response) -> {
            ...
            Log.d("Debago", "Placedetail photometadata " + photoMetadata);
            String attributions = photoMetadata.getAttributions();
            photoRequest(photoMetadata);
            sendRestaurantDetailDataToOtherFragments(phoneNumber,name,address,placeId,website,attributions);
    ...
    private void photoRequest(PhotoMetadata photoMetadata){
        ...
        placesClient.fetchPhoto(photoRequest).addOnSuccessListener((fetchPhotoResponse) -> {
            ...
            sendRestaurantDetailPhotoToOtherFragments(bitmap);
        }).addOnFailureListener((exception) -> {
            if (exception instanceof ApiException) {
                ApiException apiException = (ApiException) exception;
                int statusCode = apiException.getStatusCode();
    ...
    public void sendRestaurantDetailDataToOtherFragments(String numberPhone,String name, String address,String placeId,String website,String photoAttributions) {
        ...
        intent.putExtra(PLACE_DATA_PHOTO_ATTRIBUTIONS, photoAttributions);
