...
public class RecyclerViewListViewRestaurantSorted extends RecyclerView.Adapter<RecyclerViewListViewRestaurantSorted.ViewHolder>{
    ...
    @NonNull
    @Override
    public RecyclerViewListViewRestaurantSorted.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewListViewRestaurantSorted.ViewHolder holder, final int position) {
